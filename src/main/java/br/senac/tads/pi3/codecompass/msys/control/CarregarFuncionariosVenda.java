 ...
 * @author user
 */
@WebServlet(name = "CarregarFuncionariosVenda", urlPatterns = {"/CarregarFuncionariosVenda"})
public class CarregarFuncionariosVenda extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<Funcionario> listaFuncionario = dao.listarPorPerfilComercial();
