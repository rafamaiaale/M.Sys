 ...
 * @author user
 */
@WebServlet(name = "RetirarDoEstoque", urlPatterns = {"/RetirarDoEstoque"})
public class RetirarDoEstoque extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        int qntAtual = qntProduto - qntSolicitada;
