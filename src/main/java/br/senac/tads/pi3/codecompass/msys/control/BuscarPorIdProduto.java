...
/**
 *
 * @author lia.sshiroma1
 */
@WebServlet(name = "BuscarPorIdProduto", urlPatterns = {"/BuscarPorIdProduto"})
public class BuscarPorIdProduto extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<Produto> listaProduto = dao.buscarPorID(1);
