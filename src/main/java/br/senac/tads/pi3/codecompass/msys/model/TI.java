...
public class TI extends Funcionario{
    ...
    private String perfil = "T.I";

    public TI(String Nome_Funcionario, String Login_Funcionario, String Senha_Funcionario, String Cargo_Funcionario, String Email_Funcionario, String Filial_Funcionario, int Situacao_Funcionario, String perfil) {
