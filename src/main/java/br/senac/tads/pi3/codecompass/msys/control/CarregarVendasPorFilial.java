 ...
 * @author user
 */
@WebServlet(name = "CarregarVendasPorFilial", urlPatterns = {"/CarregarVendasPorFilial"})
public class CarregarVendasPorFilial extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<Vendas> listaVendas = dao.relatorioPorFilial(filial);
