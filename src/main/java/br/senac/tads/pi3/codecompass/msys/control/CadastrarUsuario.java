...
public class CadastrarUsuario extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String cargoUsuario = request.getParameter("cargo");
        String emailUsuario = request.getParameter("email");
        String filialUsuario = request.getParameter("filial");
        String situacaoUsuario = request.getParameter("situacao");
        String perfilUsuario = request.getParameter("perfil");
        
        Funcionario funcionario = new Funcionario();
        
        funcionario.setNomeFuncionario(nomeUsuario);
        funcionario.setLoginFuncionario(loginUsuario);
        funcionario.setSenhaFuncionario(senhaUsuario);
        funcionario.setCargoFuncionario(cargoUsuario);
        funcionario.setEmailFuncionario(emailUsuario);
        funcionario.setFilialFuncionario(filialUsuario);
        funcionario.setSituacaoFuncionario("1");
        funcionario.setPerfilFuncionario(perfilUsuario);
