 ...
 * @author user
 */
@WebServlet(name = "CarregarVendaPorProduto", urlPatterns = {"/CarregarVendaPorProduto"})
public class CarregarVendaPorProduto extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String tipo = request.getParameter("tipoP");
        
        try {
            VendasDAO dao = new VendasDAO();
            List<Vendas> listaVendas = dao.relatorioPorProduto(tipo);
